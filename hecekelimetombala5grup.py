...
def hecele():
    ...
    label1=Label(text="Kalan\n"+str(uzunluk),fg='red',font=("Times New Roman" ,30))
   
    label1.place(relx = 0.81, rely = 0.6)

    label1=Label(text="                                                                                                                                                 ",fg='blue',font=("Times New Roman" ,80))
    ...
    if len(tombala) >0:
        ...
        label1=Label(text=heceToplam+" -----> "+kelime,fg='blue',font=("Times New Roman" ,60))
...
def al():
        pencere.destroy()
        os.system("python3 hecekelimetombala5grup.py")
...
label=Label(text="1.2.3.4.5. GRUP HECE/KELİME TOMBALASI PROGRAMI",fg="red",font=("Times New Roman" ,25))
...
buton1=Button()
buton1.config(text="SEÇ", command=hecele,width='25',bg="red",fg="white",font=("Times New Roman" ,16))
buton1.place(relx = 0.08, rely = 0.85)

buton2=Button()
buton2.config(text="BAŞTAN AL", command=al,width='25',bg="red",fg="white",font=("Times New Roman" ,16))
buton2.place(relx = 0.40, rely = 0.85)

buton=Button()
buton.config(text="ÇIKIŞ",command=pencere.destroy,width='25',bg="red",fg="white",font=('Times New Roman',16))
